...
create table loan_application (
  ...
  second_cli_repayment_institute varchar(255),
  second_cli_repayment_bank_nsc varchar(255),
  second_cli_repayment_account varchar(255),
